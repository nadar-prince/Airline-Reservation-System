...
<head>
<meta charset="UTF-8">
<title>Delete Users Details</title>
...
<div class="div1">
 ...
 <div class="login">
   ...
   <% 
    ...
    <% } %>
    <!-- Form to delete user by username -->
    <form action="UserManageServlet" method="post">
        <input type="hidden" name="operation" value="delete" />
        
        <label for="uname2">Enter Username to Delete:</label>
        <input type="text" id="uname2" name="uname2" required /><br><br>
		
		<button class="b1"type="submit"> Delete User </button> 

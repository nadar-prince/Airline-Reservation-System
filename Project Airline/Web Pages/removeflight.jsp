...
<head>
<meta charset="UTF-8">
<title>Delete Flights Details</title>
...
<div class="div1">
 ...
 <div class="login">
    ...
    <form action="DeleteFlightServlet" method="post">
        <label for="flightId" style="position: relative; top: 32px; font-size:18px; display: inline-block;">Flight ID:</label>
        <input type="text" id="flightId" name="flightId" required><br>
        <button class="b1"type="submit"> Delete Flight </button> 

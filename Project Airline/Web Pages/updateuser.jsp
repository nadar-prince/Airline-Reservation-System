...
<div class="div1">
 ...
 <div class="login">
    ...
    <form action="UserManageServlet" method="post">
        ...
        <label for="uname2">Enter Username to Update:</label>
    ...
    <c:if test="${not empty fname}">
        <form action="UserManageServlet" method="post">
            ...
            <input type="text" id="fname" name="fname" value="${fname}" required /><br><br>

            <label for="lname">Last Name:</label>
            <input type="text" id="lname" name="lname" value="${lname}" required /><br><br>

            <label for="uname2">Username:</label>
            <input type="text" id="uname2" name="uname2" value="${uname2}" required readonly/><br><br>

            <label for="upwd">Password:</label>
            <input type="password" id="upwd" name="upwd" value="${upwd}" required /><br><br>

            <label for="uemail">Email:</label>
            <input type="email" id="uemail" name="uemail" value="${uemail}" required /><br><br>

            <label for="umobile">Mobile:</label>
            <input type="text" id="umobile" name="umobile" value="${umobile}" required /><br><br>
		
		<button class="b1"type="submit"> Update User </button> 
        <button class="b2" type="submit"> <a style="text-decoration: none" href="admindash.jsp" "> Cancel </a> </button> 
        </form>
    </c:if>
    </div>
</body>
